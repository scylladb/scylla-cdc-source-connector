 ...
 * <actual_value>}}
 *
 * <p>With preimages enabled (experimental.preimages.enabled=true), the "before" field will be
 * populated with the preimage data on UPDATE and DELETE operations.
 */
public class ScyllaTypesPrimitiveLegacyPreimageEnabledIT
    extends ScyllaTypesPrimitiveBase<String, String> {

  @Override
  KafkaConsumer<String, String> buildConsumer(String connectorName, String tableName) {
    return buildLegacyPlainConnector(connectorName, tableName, true);
  }
